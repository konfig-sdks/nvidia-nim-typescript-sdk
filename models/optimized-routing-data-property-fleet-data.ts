...
import { FleetData2 } from './fleet-data2';
import { VehicleOrderMatch1 } from './vehicle-order-match1';

/**
 * All Fleet information
 * @export
 * @interface OptimizedRoutingDataPropertyFleetData
 */
export interface OptimizedRoutingDataPropertyFleetData {
    /**
     ...
     * @memberof OptimizedRoutingDataPropertyFleetData
     */

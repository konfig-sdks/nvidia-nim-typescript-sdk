...
import { OrderVehicleMatch2 } from './order-vehicle-match2';
import { ServiceTimesProperty } from './service-times-property';
import { TaskData2 } from './task-data2';

/**
 * All Task information
 * @export
 * @interface OptimizedRoutingDataPropertyTaskData
 */
export interface OptimizedRoutingDataPropertyTaskData {
    /**
     * dtype: int32, location >= 0.    Location where the task has been requested.
     * @type {Array<number>}
     * @memberof OptimizedRoutingDataPropertyTaskData
     */
     ...
     * @memberof OptimizedRoutingDataPropertyTaskData
     */
    'service_times'?: ServiceTimesProperty | null;
    /**
     ...
     * @type {Array<OrderVehicleMatch2>}
     * @memberof OptimizedRoutingDataPropertyTaskData
     */
    'order_vehicle_match'?: Array<OrderVehicleMatch2> | null;
    /**

...
import { OrderVehicleMatch1 } from './order-vehicle-match1';
import { ServiceTimesProperty } from './service-times-property';
import { TaskData1 } from './task-data1';

/**
 * All Task information
 * @export
 * @interface OptimizedRoutingDataTaskData
 */
export interface OptimizedRoutingDataTaskData {
    /**
     * dtype: int32, location >= 0.    Location where the task has been requested.
     * @type {Array<number>}
     * @memberof OptimizedRoutingDataTaskData
     */
     ...
     * @type {Array<OrderVehicleMatch1>}
     * @memberof OptimizedRoutingDataTaskData
     */
    'order_vehicle_match'?: Array<OrderVehicleMatch1> | null;
    /**

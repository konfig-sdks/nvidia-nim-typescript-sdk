 ...
 * 
 * @export
 * @interface VehicleData3
 */
export interface VehicleData3 {
    /**
     * task_ids being assigned to vehicle along with depot and breaks
     * @type {Array<string>}
     * @memberof VehicleData3
     */
     ...
     * @memberof VehicleData3
     */
    'type'?: Array<VehicleData3TypeEnum>;
}

type VehicleData3TypeEnum = 'Depot' | 'Pickup' | 'Delivery' | 'Break' | 'w'

...
import { FleetData3 } from './fleet-data3';
import { VehicleOrderMatch2 } from './vehicle-order-match2';

/**
 * All Fleet information
 * @export
 * @interface OptimizedRoutingDataProperty1FleetData
 */
export interface OptimizedRoutingDataProperty1FleetData {
    /**
     ...
     * @memberof OptimizedRoutingDataProperty1FleetData
     */
     ...
     * @type {Array<VehicleOrderMatch2>}
     * @memberof OptimizedRoutingDataProperty1FleetData
     */
    'vehicle_order_match'?: Array<VehicleOrderMatch2> | null;
    /**
